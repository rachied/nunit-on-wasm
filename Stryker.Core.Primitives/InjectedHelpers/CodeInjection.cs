...
namespace Stryker.Core.Primitives.InjectedHelpers
{
    public static class CodeInjection
    {
        // files to be injected into the mutated assembly
        private static readonly string[] Files = {"Stryker.Core.Primitives.InjectedHelpers.MutantControl.cs",
            "Stryker.Core.Primitives.InjectedHelpers.Coverage.MutantContext.cs"};
        ...
        {
            var helper = GetSourceFromResource("Stryker.Core.Primitives.InjectedHelpers.MutantControl.cs");
